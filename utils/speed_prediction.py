...
def predict_speed(top, bottom, right, left, current_frame_number, crop_img, roi_position):      
        ...
        if ((len(bottom_position_of_detected_vehicle) != 0) and bottom-bottom_position_of_detected_vehicle[0] > 0 and 205<bottom_position_of_detected_vehicle[0] and bottom_position_of_detected_vehicle[0]<210 and roi_position<bottom ):
